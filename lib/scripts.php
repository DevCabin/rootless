...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '5896ad143622411baf666d8a2b653724');
  ...
  wp_register_script('ekko-lightbox', get_template_directory_uri() . '/assets/js/vendor/ekko-lightbox.js', false, null, false);
